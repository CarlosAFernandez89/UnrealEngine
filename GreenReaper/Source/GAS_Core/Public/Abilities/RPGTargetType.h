...
class GAS_CORE_API URPGTargetType : public UObject
{
	GENERATED_BODY()
...
class GAS_CORE_API URPGTargetType_UseOwner : public URPGTargetType
{
	GENERATED_BODY()
...
UCLASS(NotBlueprintable)
class GAS_CORE_API URPGTargetType_UseEventData : public URPGTargetType
{
	GENERATED_BODY()
