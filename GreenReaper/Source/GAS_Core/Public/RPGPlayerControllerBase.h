...
UCLASS()
class GAS_CORE_API ARPGPlayerControllerBase : public APlayerController, public IRPGInventoryInterface
{
	GENERATED_BODY()
...
UCLASS(Within = RPGPlayerControllerBase)
class UArenaCheatManager : public UCheatManager
{
	GENERATED_BODY()
