...
UCLASS()
class GAS_CORE_API ARPGCharacterBase : public ACharacter, public IAbilitySystemInterface, public IGenericTeamAgentInterface
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	/* Get starting pos of actors */
	FVector AStartingPos;

	/* flag for determining whether an actor is dead or not */
	bool isDead;
