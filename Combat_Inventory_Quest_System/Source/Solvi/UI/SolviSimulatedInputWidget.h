...
#include "SolviSimulatedInputWidget.generated.h"
 ...
 * 
 */
UCLASS(meta=( DisplayName="Solvi Simulated Input Widget" ))
class SOLVI_API USolviSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()

	public:
	
	USolviSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
