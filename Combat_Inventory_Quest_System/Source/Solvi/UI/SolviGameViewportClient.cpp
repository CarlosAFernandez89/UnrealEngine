...
#include "SolviGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SolviGameViewportClient)
...
USolviGameViewportClient::USolviGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void USolviGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
