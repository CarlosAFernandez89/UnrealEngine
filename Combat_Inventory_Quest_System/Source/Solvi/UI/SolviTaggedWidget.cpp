...
#include "SolviTaggedWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SolviTaggedWidget)

//@TODO: The other TODOs in this file are all related to tag-based showing/hiding of widgets, see UE-142237

USolviTaggedWidget::USolviTaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void USolviTaggedWidget::NativeConstruct()
{
...
void USolviTaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void USolviTaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void USolviTaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
