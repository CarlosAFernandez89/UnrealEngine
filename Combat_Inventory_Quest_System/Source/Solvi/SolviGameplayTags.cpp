...
namespace SolviGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Status_Movement_Blocked, "Status.Movement.Blocked", "Target has blocked movement.");
	...
	// When extending Solvi, you can create your own movement modes but you need to update GetCustomMovementModeTagMap()
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Movement_Mode_Custom, "Movement.Mode.Custom", "This is invalid and should be replaced with custom tags.  See SolviGameplayTags::CustomMovementModeTagMap.");
	...
	FGameplayTag SolviGameplayTags::FindTagByString(const FString& TagString, bool bMatchPartialString)
	{
