...
#include "MyAsyncGameplayEffectStackChanged.generated.h"
...
class DES350PROJECT_API UMyAsyncGameplayEffectStackChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
	...
	static UMyAsyncGameplayEffectStackChanged* ListenForGameplayEffectStackChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTag EffectGameplayTag);
