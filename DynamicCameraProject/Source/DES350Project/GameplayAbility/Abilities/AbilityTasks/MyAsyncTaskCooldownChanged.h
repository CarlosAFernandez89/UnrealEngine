...
#include "MyAsyncTaskCooldownChanged.generated.h"
...
class DES350PROJECT_API UMyAsyncTaskCooldownChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	static UMyAsyncTaskCooldownChanged* ListenForCooldownChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayTagContainer CooldownTags, bool UseServerCooldown);
